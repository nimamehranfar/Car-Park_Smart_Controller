...
void setup() {
  ...
  pinMode(1, OUTPUT); //0s 0
  pinMode(0, OUTPUT); //0s 1
  pinMode(A4, OUTPUT); //0s 3
  pinMode(A5, OUTPUT); //0s 2
  ...
  pinMode(A0, OUTPUT); //0s 7
  pinMode(A1, OUTPUT); //0s 6
  pinMode(A2, OUTPUT); //0s 5
  pinMode(A3, OUTPUT); //0s 4
}
